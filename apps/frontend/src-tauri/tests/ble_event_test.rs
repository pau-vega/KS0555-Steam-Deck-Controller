...
mod tests {
    ...
    fn test_setup_event_listener_exists() {
        ...
        assert!(
            content.contains("pub fn setup_event_listener"),
    ...
    fn test_event_listener_handles_disconnect() {
        ...
        assert!(
            content.contains("CentralEvent::DeviceDisconnected"),
    ...
    fn test_event_listener_spawned_in_main() {
        ...
        assert!(
            content.contains("setup_event_listener"),
    ...
    fn test_event_listener_spawned_async() {
        ...
        assert!(
            content.contains("tauri::async_runtime::spawn"),
