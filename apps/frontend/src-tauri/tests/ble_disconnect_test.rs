...
mod tests {
    ...
    fn test_ble_disconnect_function_exists() {
        ...
        assert!(
            content.contains("pub async fn ble_disconnect"),
    ...
    fn test_ble_disconnect_calls_peripheral_disconnect() {
        ...
        assert!(
            content.contains("peripheral.disconnect().await"),
    ...
    fn test_ble_disconnect_clears_state() {
        ...
        assert!(
            content.contains("state.set(None)"),
    ...
    fn test_ble_disconnect_handles_none_case() {
        ...
        assert!(
            content.contains("None => Err(\"Not connected"),
