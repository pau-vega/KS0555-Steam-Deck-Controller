...
mod tests {
    ...
    fn test_ble_send_validates_command_length() {
        ...
        assert!(
            content.contains("command.len() != 1"),
            "Should validate command is single character"
        );
        assert!(
            content.contains("F/B/L/R/S"),
    ...
    fn test_ble_send_uses_without_response() {
        ...
        assert!(
            content.contains("WithoutResponse"),
    ...
    fn test_ble_send_bt24_char_uuid() {
        ...
        assert!(
            content.contains("BT24_CHAR_UUID"),
    ...
    fn test_ble_send_requires_connection() {
        ...
        assert!(
            content.contains("Not connected to BT24 device"),
    ...
    fn test_ble_send_finds_characteristic() {
        ...
        assert!(
            content.contains("BT24 characteristic not found"),
